...
def S37():
    ...
    if ("iar" == "iar" or "iar" == ""):
        ...
        GCC_TOOLCHAIN_PATH = shortPath(r"file:/C:/Program%20Files%20(x86)/IAR%20Systems/Embedded%20Workbench%208.4/".replace(
            "file:", "").replace("%20", " "))
...
def EBL():
    ...
    EBL_COMMAND = START_FLAGS + shortPath(r"C:\SiliconLabs\SimplicityStudio\v5\developer\adapter_packs\commander\commander.exe").replace(
        " ", "\ ") + " ebl create " + EBL_FILE + " --app " + S37_BINARY + " --device EFR32MG21A010F768IM32 " + CONVERT_FLAGS
...
def GBL():
    ...
    GBL_COMMAND = START_FLAGS + shortPath(r"C:\SiliconLabs\SimplicityStudio\v5\developer\adapter_packs\commander\commander.exe").replace(
        " ", "\ ") + " gbl create " + GBL_FILE + " --app " + S37_BINARY + " --device EFR32MG21A010F768IM32"
