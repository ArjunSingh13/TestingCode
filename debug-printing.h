...
// Printing macros for cluster: Encelium Auxiliary Tunnel Cluster
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_ENCELIUM_AUX_TUNNEL_CLUSTER)
#define emberAfEnceliumAuxTunnelClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_ENCELIUM_AUX_TUNNEL_CLUSTER, __VA_ARGS__)
#define emberAfEnceliumAuxTunnelClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_ENCELIUM_AUX_TUNNEL_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfEnceliumAuxTunnelClusterFlush()
#define emberAfEnceliumAuxTunnelClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_ENCELIUM_AUX_TUNNEL_CLUSTER) ) { x; }
#define emberAfEnceliumAuxTunnelClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_ENCELIUM_AUX_TUNNEL_CLUSTER, (buffer), (len), (withSpace))
#define emberAfEnceliumAuxTunnelClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_ENCELIUM_AUX_TUNNEL_CLUSTER, (buffer))
#else
#define emberAfEnceliumAuxTunnelClusterPrint(...)
#define emberAfEnceliumAuxTunnelClusterPrintln(...)
#define emberAfEnceliumAuxTunnelClusterFlush()
#define emberAfEnceliumAuxTunnelClusterDebugExec(x)
#define emberAfEnceliumAuxTunnelClusterPrintBuffer(buffer, len, withSpace)
#define emberAfEnceliumAuxTunnelClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_ENCELIUM_AUX_TUNNEL_CLUSTER)
...
// Printing macros for cluster: Encelium Interface Cluster
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_ENCELIUM_INTERFACE_CLUSTER)
#define emberAfEnceliumInterfaceClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_ENCELIUM_INTERFACE_CLUSTER, __VA_ARGS__)
#define emberAfEnceliumInterfaceClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_ENCELIUM_INTERFACE_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfEnceliumInterfaceClusterFlush()
#define emberAfEnceliumInterfaceClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_ENCELIUM_INTERFACE_CLUSTER) ) { x; }
#define emberAfEnceliumInterfaceClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_ENCELIUM_INTERFACE_CLUSTER, (buffer), (len), (withSpace))
#define emberAfEnceliumInterfaceClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_ENCELIUM_INTERFACE_CLUSTER, (buffer))
#else
#define emberAfEnceliumInterfaceClusterPrint(...)
#define emberAfEnceliumInterfaceClusterPrintln(...)
#define emberAfEnceliumInterfaceClusterFlush()
#define emberAfEnceliumInterfaceClusterDebugExec(x)
#define emberAfEnceliumInterfaceClusterPrintBuffer(buffer, len, withSpace)
#define emberAfEnceliumInterfaceClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_ENCELIUM_INTERFACE_CLUSTER)


// Printing macros for cluster: Encelium Diagnostics
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_ENCELIUM_DIAGNOSTICS_CLUSTER)
#define emberAfEnceliumDiagnosticsClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_ENCELIUM_DIAGNOSTICS_CLUSTER, __VA_ARGS__)
#define emberAfEnceliumDiagnosticsClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_ENCELIUM_DIAGNOSTICS_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfEnceliumDiagnosticsClusterFlush()
#define emberAfEnceliumDiagnosticsClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_ENCELIUM_DIAGNOSTICS_CLUSTER) ) { x; }
#define emberAfEnceliumDiagnosticsClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_ENCELIUM_DIAGNOSTICS_CLUSTER, (buffer), (len), (withSpace))
#define emberAfEnceliumDiagnosticsClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_ENCELIUM_DIAGNOSTICS_CLUSTER, (buffer))
#else
#define emberAfEnceliumDiagnosticsClusterPrint(...)
#define emberAfEnceliumDiagnosticsClusterPrintln(...)
#define emberAfEnceliumDiagnosticsClusterFlush()
#define emberAfEnceliumDiagnosticsClusterDebugExec(x)
#define emberAfEnceliumDiagnosticsClusterPrintBuffer(buffer, len, withSpace)
#define emberAfEnceliumDiagnosticsClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_ENCELIUM_DIAGNOSTICS_CLUSTER)


// Printing macros for cluster: Encelium DEXAL driver data
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_ENCELIUM_DEXAL_DRIVER_DATA_CLUSTER)
#define emberAfEnceliumDexalDriverDataClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_ENCELIUM_DEXAL_DRIVER_DATA_CLUSTER, __VA_ARGS__)
#define emberAfEnceliumDexalDriverDataClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_ENCELIUM_DEXAL_DRIVER_DATA_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfEnceliumDexalDriverDataClusterFlush()
#define emberAfEnceliumDexalDriverDataClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_ENCELIUM_DEXAL_DRIVER_DATA_CLUSTER) ) { x; }
#define emberAfEnceliumDexalDriverDataClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_ENCELIUM_DEXAL_DRIVER_DATA_CLUSTER, (buffer), (len), (withSpace))
#define emberAfEnceliumDexalDriverDataClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_ENCELIUM_DEXAL_DRIVER_DATA_CLUSTER, (buffer))
#else
#define emberAfEnceliumDexalDriverDataClusterPrint(...)
#define emberAfEnceliumDexalDriverDataClusterPrintln(...)
#define emberAfEnceliumDexalDriverDataClusterFlush()
#define emberAfEnceliumDexalDriverDataClusterDebugExec(x)
#define emberAfEnceliumDexalDriverDataClusterPrintBuffer(buffer, len, withSpace)
#define emberAfEnceliumDexalDriverDataClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_ENCELIUM_DEXAL_DRIVER_DATA_CLUSTER)
...
// Printing macros for cluster: Encelium Emergency Cluster
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_ENCELIUM_EMERGENCY_CLUSTER)
#define emberAfEnceliumEmergencyClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_ENCELIUM_EMERGENCY_CLUSTER, __VA_ARGS__)
#define emberAfEnceliumEmergencyClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_ENCELIUM_EMERGENCY_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfEnceliumEmergencyClusterFlush()
#define emberAfEnceliumEmergencyClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_ENCELIUM_EMERGENCY_CLUSTER) ) { x; }
#define emberAfEnceliumEmergencyClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_ENCELIUM_EMERGENCY_CLUSTER, (buffer), (len), (withSpace))
#define emberAfEnceliumEmergencyClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_ENCELIUM_EMERGENCY_CLUSTER, (buffer))
#else
#define emberAfEnceliumEmergencyClusterPrint(...)
#define emberAfEnceliumEmergencyClusterPrintln(...)
#define emberAfEnceliumEmergencyClusterFlush()
#define emberAfEnceliumEmergencyClusterDebugExec(x)
#define emberAfEnceliumEmergencyClusterPrintBuffer(buffer, len, withSpace)
#define emberAfEnceliumEmergencyClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_ENCELIUM_EMERGENCY_CLUSTER)
