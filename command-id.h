...
#define ZCL_SELECT_MODEL_COMMAND_ID 0xE0 // Ver.: always mfgCode: 0x110C
#define ZCL_GO_TO_SLEEP_COMMAND_ID 0xE1 // Ver.: always mfgCode: 0x110C
...
#define ZCL_RECEIVED_INTERPAN_UNICAST_MSG_COMMAND_ID 0xE6 // Ver.: always mfgCode: 0x110C
#define ZCL_RECEIVED_INTERPAN_BROADCAST_MSG_COMMAND_ID 0xE7 // Ver.: always mfgCode: 0x110C
...
#define ZCL_SEND_INTERPAN_UNICAST_MSG_COMMAND_ID 0xE4 // Ver.: always mfgCode: 0x110C
#define ZCL_SEND_INTERPAN_BROADCAST_MSG_COMMAND_ID 0xE5 // Ver.: always mfgCode: 0x110C
...
// Command types for cluster: Encelium Auxiliary Tunnel Cluster
// Cluster specification level: UNKNOWN

// Server to client
#define ZCL_MSG_RESPONSE_COMMAND_ID 0x01 // Ver.: always mfgCode: 0x110C
#define ZCL_MULTI_MASTER_MSG_COMMAND_ID 0x02 // Ver.: always mfgCode: 0x110C

// Client to server
#define ZCL_SEND_MSG_COMMAND_ID 0x00 // Ver.: always mfgCode: 0x110C
...
// Command types for cluster: Encelium Interface Cluster
// Cluster specification level: UNKNOWN

// Server to client
#define ZCL_INTERFACE_CONFIG_COMMAND_ID 0x00 // Ver.: always mfgCode: 0x110C

// Client to server
#define ZCL_RESCAN_INTERFACE_COMMAND_ID 0x00 // Ver.: always mfgCode: 0x110C
#define ZCL_SET_INTERFACE_COMMAND_ID 0x01 // Ver.: always mfgCode: 0x110C


// Command types for cluster: Encelium Diagnostics
// Cluster specification level: UNKNOWN

// Server to client
#define ZCL_PROXIMITY_NODES_COMMAND_ID 0x01 // Ver.: always mfgCode: 0x110C
#define ZCL_REPORT_NEIGHBORS_RESPONSE_COMMAND_ID 0x00 // Ver.: always mfgCode: 0x110C
#define ZCL_REPORT_PROXIMITY_NODES_RESPONSE_COMMAND_ID 0x02 // Ver.: always mfgCode: 0x110C

// Client to server
#define ZCL_REPORT_NEIGHBORS_COMMAND_ID 0x00 // Ver.: always mfgCode: 0x110C
#define ZCL_REPORT_PROXIMITY_NODES_COMMAND_ID 0x02 // Ver.: always mfgCode: 0x110C
#define ZCL_RESET_PROXIMITY_NODES_DATA_COMMAND_ID 0x03 // Ver.: always mfgCode: 0x110C
#define ZCL_REPORT_AND_TRIGGER_PROXIMITY_NODES_COMMAND_ID 0x04 // Ver.: always mfgCode: 0x110C


// Command types for cluster: Encelium DEXAL driver data
// Cluster specification level: UNKNOWN

// Server to client
#define ZCL_QUERY_DRIVER_DATA_RESPONSE_COMMAND_ID 0x01 // Ver.: always mfgCode: 0x110C
#define ZCL_QUERY_O_E_M_DATA_RESPONSE_COMMAND_ID 0x02 // Ver.: always mfgCode: 0x110C

// Client to server
#define ZCL_QUERY_DRIVER_DATA_COMMAND_ID 0x01 // Ver.: always mfgCode: 0x110C
#define ZCL_QUERY_O_E_M_DATA_COMMAND_ID 0x02 // Ver.: always mfgCode: 0x110C
...
// Command types for cluster: Encelium Emergency Cluster
// Cluster specification level: UNKNOWN

// Client to server
#define ZCL_START_TEST_COMMAND_ID 0x04 // Ver.: always mfgCode: 0x110C
#define ZCL_STOP_TEST_COMMAND_ID 0x05 // Ver.: always mfgCode: 0x110C
#define ZCL_INHIBIT_COMMAND_ID 0x01 // Ver.: always mfgCode: 0x110C
#define ZCL_START_IDENTIFY_COMMAND_ID 0x06 // Ver.: always mfgCode: 0x110C
#define ZCL_PROLONG_TIME_COMMAND_ID 0x0F // Ver.: always mfgCode: 0x110C
