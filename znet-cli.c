...
void emAfEnceliumCommissioningForceStateAutoJoinCommand(void);
void emAfEnceliumCommissioningForceStateDefaultCommand(void);
void emAfEnceliumCommissioningPrintInfoCommand(void);
void emAfEnceliumCommissioningLeaveNetworkCommand(void);
void emAfEnceliumCommissioningForceStatePendingCommand(void);
static EmberCommandEntry emberCommandPluginEnceliumCommissioningModeTable[] = {
  emberCommandEntryActionWithDetails("autojoin", emAfEnceliumCommissioningForceStateAutoJoinCommand, "", "Force commissioning state to auto-join.", NULL),
  emberCommandEntryActionWithDetails("default", emAfEnceliumCommissioningForceStateDefaultCommand, "", "Force commissioning state to default.", NULL),
  emberCommandEntryActionWithDetails("info", emAfEnceliumCommissioningPrintInfoCommand, "", "Print commissioning mode info.", NULL),
  emberCommandEntryActionWithDetails("leave", emAfEnceliumCommissioningLeaveNetworkCommand, "", "Leave the current network.", NULL),
  emberCommandEntryActionWithDetails("pending", emAfEnceliumCommissioningForceStatePendingCommand, "", "Force commissioning state to pending.", NULL),
  emberCommandEntryTerminator(),
};
void emAfEnceliumCommissioningSetChannelMaskCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginEnceliumCommissioningNetworkChmaskCommandArguments[] = {
  "channel mask",
  NULL
};
#endif
...
void emAfEnceliumCommissioningLoadKeyFromIndexCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginEnceliumCommissioningNetworkKeyindexCommandArguments[] = {
  "key index",
  NULL
};
#endif
...
void emAfEnceliumCommissioningValidateNetworkCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginEnceliumCommissioningNetworkValidateCommandArguments[] = {
  "reboot request",
  NULL
};
#endif
...
void emAfEnceliumCommissioningSetExtendedPanIdCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginEnceliumCommissioningNetworkXpanidCommandArguments[] = {
  "extended Pan ID",
  NULL
};
#endif
...
static EmberCommandEntry emberCommandPluginEnceliumCommissioningNetworkTable[] = {
  emberCommandEntryActionWithDetails("chmask", emAfEnceliumCommissioningSetChannelMaskCommand, "w", "Specify network channel mask to search in.", pluginEnceliumCommissioningNetworkChmaskCommandArguments),
  emberCommandEntryActionWithDetails("keyindex", emAfEnceliumCommissioningLoadKeyFromIndexCommand, "u", "Select link key index to join with.", pluginEnceliumCommissioningNetworkKeyindexCommandArguments),
  emberCommandEntryActionWithDetails("validate", emAfEnceliumCommissioningValidateNetworkCommand, "u", "Validate current network as commissioned.", pluginEnceliumCommissioningNetworkValidateCommandArguments),
  emberCommandEntryActionWithDetails("xpanid", emAfEnceliumCommissioningSetExtendedPanIdCommand, "b", "Specify extended pan ID to search for.", pluginEnceliumCommissioningNetworkXpanidCommandArguments),
  emberCommandEntryTerminator(),
};
static EmberCommandEntry emberCommandPluginEnceliumCommissioningTable[] = {
  emberCommandEntrySubMenu("mode", emberCommandPluginEnceliumCommissioningModeTable, ""),
  emberCommandEntrySubMenu("network", emberCommandPluginEnceliumCommissioningNetworkTable, ""),
  emberCommandEntryTerminator(),
};
void emAfEnceliumInterfaceEnableCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginEnceliumInterfaceEnableCommandArguments[] = {
  "Endpoint",
  "Enable",
  NULL
};
...
void emAfEnceliumInterfacePrintAllCommand(void);
void emAfEnceliumInterfaceSetCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginEnceliumInterfaceSetCommandArguments[] = {
  "Endpoint",
  "Interface Type",
  NULL
};
...
void emAfEnceliumInterfaceSetActiveCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginEnceliumInterfaceSetactiveCommandArguments[] = {
  "Endpoint",
  "SetActive",
  NULL
};
...
static EmberCommandEntry emberCommandPluginEnceliumInterfaceTable[] = {
  emberCommandEntryActionWithDetails("enable", emAfEnceliumInterfaceEnableCommand, "uu", "Enables/disables an endpoin ...", pluginEnceliumInterfaceEnableCommandArguments),
  emberCommandEntryActionWithDetails("print", emAfEnceliumInterfacePrintAllCommand, "", "Prints encelium-interface data.", NULL),
  emberCommandEntryActionWithDetails("set", emAfEnceliumInterfaceSetCommand, "uu", "Sets the encelium-interface type.", pluginEnceliumInterfaceSetCommandArguments),
  emberCommandEntryActionWithDetails("setactive", emAfEnceliumInterfaceSetActiveCommand, "uu", "Activates/deactivates an endpoin ...", pluginEnceliumInterfaceSetactiveCommandArguments),
  emberCommandEntryTerminator(),
};
void emAfEnceliumInterpanSendInterfaceConfigCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginEnceliumInterpanSendInterfaceConfigCommandArguments[] = {
  "Interface Index",
  NULL
};
#endif
...
static EmberCommandEntry emberCommandPluginEnceliumInterpanTable[] = {
  emberCommandEntryActionWithDetails("send-interface-config", emAfEnceliumInterpanSendInterfaceConfigCommand, "u", "Broadcasts interface-config interpan command.", pluginEnceliumInterpanSendInterfaceConfigCommandArguments),
  emberCommandEntryTerminator(),
};
...
static EmberCommandEntry emberCommandPluginTable[] = {
  ...
  emberCommandEntrySubMenu("encelium-commissioning", emberCommandPluginEnceliumCommissioningTable, ""),
  emberCommandEntrySubMenu("encelium-interface", emberCommandPluginEnceliumInterfaceTable, ""),
  emberCommandEntrySubMenu("encelium-interpan", emberCommandPluginEnceliumInterpanTable, ""),
