...
/** @brief This command is sent to the device for model selection.
 *
 * Cluster: Basic, Attributes for determining basic information about a device, setting user device information such as location, and enabling a device.
 * Command: SelectModel
 * @param model uint8_t
 */
#define emberAfFillCommandBasicClusterSelectModel(model) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_BASIC_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_SELECT_MODEL_COMMAND_ID, \
                                                "u", \
                                                model);


/** @brief This command is sent to the device to go to sleep.
 *
 * Cluster: Basic, Attributes for determining basic information about a device, setting user device information such as location, and enabling a device.
 * Command: GoToSleep
 * @param duration uint16_t
 */
#define emberAfFillCommandBasicClusterGoToSleep(duration) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_BASIC_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_GO_TO_SLEEP_COMMAND_ID, \
                                                "v", \
                                                duration);
...
/** @brief Request the router device to emit an interpan unicast message specified in the payload of this command.
 *
 * Cluster: Commissioning, Attributes and commands for commissioning and managing a ZigBee device.
 * Command: SendInterpanUnicastMsg
 * @param destination uint8_t*
 * @param channelMask uint32_t
 * @param jitter uint8_t
 * @param msgLen uint8_t
 * @param interpanMsg uint8_t*
 * @param interpanMsgLen uint16_t
 */
#define emberAfFillCommandCommissioningClusterSendInterpanUnicastMsg(destination, \
                                                                     channelMask, \
                                                                     jitter, \
                                                                     msgLen, \
                                                                     interpanMsg, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_COMMISSIONING_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_SEND_INTERPAN_UNICAST_MSG_COMMAND_ID, \
                                                "8wuub", \
                                                destination, \
                                                channelMask, \
                                                jitter, \
...
/** @brief Request the router device to emit an interpan broadcast message specified in the payload of this command.
 *
 * Cluster: Commissioning, Attributes and commands for commissioning and managing a ZigBee device.
 * Command: SendInterpanBroadcastMsg
 * @param channelMask uint32_t
 * @param jitter uint8_t
 * @param msgLen uint8_t
 * @param interpanMsg uint8_t*
 * @param interpanMsgLen uint16_t
 */
#define emberAfFillCommandCommissioningClusterSendInterpanBroadcastMsg(channelMask, \
                                                                       jitter, \
                                                                       msgLen, \
                                                                       interpanMsg, \
                                                                       interpanMsgLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_COMMISSIONING_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_SEND_INTERPAN_BROADCAST_MSG_COMMAND_ID, \
                                                "wuub", \
                                                channelMask, \
                                                jitter, \
                                                msgLen, \
...
/** @brief Request the coordinator the received interpan unicast message as specified in the payload of this command.
 *
 * Cluster: Commissioning, Attributes and commands for commissioning and managing a ZigBee device.
 * Command: ReceivedInterpanUnicastMsg
 ...
 * @param interpanMsgLen uint16_t
 */
#define emberAfFillCommandCommissioningClusterReceivedInterpanUnicastMsg(source, \
                                                                         channel, \
                                                                         rssi, \
                                                                         msgLen, \
                                                                         interpanMsg, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_COMMISSIONING_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_RECEIVED_INTERPAN_UNICAST_MSG_COMMAND_ID, \
                                                "8uuub", \
                                                source, \
                                                channel, \
                                                rssi, \
...
/** @brief Request the coordinator the received interpan broadcast message as specified in the payload of this command.
 *
 * Cluster: Commissioning, Attributes and commands for commissioning and managing a ZigBee device.
 * Command: ReceivedInterpanBroadcastMsg
 * @param source uint8_t*
 * @param channel uint8_t
 * @param rssi int8_t
 * @param msgLen uint8_t
 ...
 * @param interpanMsgLen uint16_t
 */
#define emberAfFillCommandCommissioningClusterReceivedInterpanBroadcastMsg(source, \
                                                                           channel, \
                                                                           rssi, \
                                                                           msgLen, \
                                                                           interpanMsg, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_COMMISSIONING_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_RECEIVED_INTERPAN_BROADCAST_MSG_COMMAND_ID, \
                                                "8uuub", \
                                                source, \
                                                channel, \
                                                rssi, \
...
/** @name Encelium Auxiliary Tunnel Cluster Commands */
// @{
/** @brief Send Message
 *
 * Cluster: Encelium Auxiliary Tunnel Cluster, This cluster provides wireless transport to DALI protocol
 * Command: SendMsg
 * @param protocol uint8_t
 * @param message uint8_t*
 * @param messageLen uint16_t
 */
#define emberAfFillCommandEnceliumAuxTunnelClusterSendMsg(protocol, \
                                                          message, \
                                                          messageLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_ENCELIUM_AUX_TUNNEL_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_SEND_MSG_COMMAND_ID, \
                                                "ub", \
                                                protocol, \
                                                message, \
                                                messageLen);
 ...
 * @param messageLen uint16_t
 */
#define emberAfFillCommandEnceliumAuxTunnelClusterMsgResponse(protocol, \
                                                              message, \
                                                              messageLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
...
/** @brief Multi Master Message
 *
 * Cluster: Encelium Auxiliary Tunnel Cluster, This cluster provides wireless transport to DALI protocol
 * Command: MultiMasterMsg
 * @param protocol uint8_t
 * @param message uint8_t*
 * @param messageLen uint16_t
 */
#define emberAfFillCommandEnceliumAuxTunnelClusterMultiMasterMsg(protocol, \
                                                                 message, \
                                                                 messageLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                ...
                                                ZCL_ENCELIUM_AUX_TUNNEL_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_MULTI_MASTER_MSG_COMMAND_ID, \
                                                "ub", \
                                                protocol, \
                                                message, \
                                                messageLen);
...
/** @} END Encelium Auxiliary Tunnel Cluster Commands */
...
/** @name Encelium Interface Cluster Commands */
// @{
/** @brief Rescan Interface
 *
 * Cluster: Encelium Interface Cluster, This cluster provides means to control interface configuration
 * Command: RescanInterface
 * @param interfaceId uint8_t
 */
#define emberAfFillCommandEnceliumInterfaceClusterRescanInterface(interfaceId) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_ENCELIUM_INTERFACE_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_RESCAN_INTERFACE_COMMAND_ID, \
                                                "u", \
                                                interfaceId);
 ...
 * @param interfaceId uint8_t
 * @param interfaceType uint8_t
 */
#define emberAfFillCommandEnceliumInterfaceClusterSetInterface(interfaceId, \
                                                               interfaceType) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
 ...
 *
 * Cluster: Encelium Interface Cluster, This cluster provides means to control interface configuration
 * Command: InterfaceConfig
 * @param interfaceType1 uint8_t
 * @param interfaceType2 uint8_t
 */
#define emberAfFillCommandEnceliumInterfaceClusterInterfaceConfig(interfaceType1, \
                                                                  interfaceType2) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
...
/** @} END Encelium Interface Cluster Commands */


/** @name Encelium Diagnostics Commands */
// @{
/** @brief Report neighbors request.
 *
 * Cluster: Encelium Diagnostics, This cluster provides means to monitor network health by providing data on the bi-directional
      RSSI and LQI connective strength between nodes.
 * Command: ReportNeighbors
 * @param startIndex uint8_t
 */
#define emberAfFillCommandEnceliumDiagnosticsClusterReportNeighbors(startIndex) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_ENCELIUM_DIAGNOSTICS_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_REPORT_NEIGHBORS_COMMAND_ID, \
                                                "u", \
                                                startIndex);


/** @brief Broadcast proximity nodes.
 *
 * Cluster: Encelium Diagnostics, This cluster provides means to monitor network health by providing data on the bi-directional
      RSSI and LQI connective strength between nodes.
 * Command: ProximityNodes
 * @param startIndex uint8_t
 * @param entries uint8_t
 * @param proximityNodes uint8_t*
 * @param proximityNodesLen uint16_t
 */
#define emberAfFillCommandEnceliumDiagnosticsClusterProximityNodes(startIndex, \
                                                                   entries, \
                                                                   proximityNodes, \
                                                                   proximityNodesLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_ENCELIUM_DIAGNOSTICS_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_PROXIMITY_NODES_COMMAND_ID, \
                                                "uub", \
                                                startIndex, \
                                                entries, \
                                                proximityNodes, \
...
/** @brief Report neigbors response.
 *
 * Cluster: Encelium Diagnostics, This cluster provides means to monitor network health by providing data on the bi-directional
      RSSI and LQI connective strength between nodes.
 * Command: ReportNeighborsResponse
 * @param startIndex uint8_t
 * @param entries uint8_t
 * @param neighborEntry uint8_t*
 * @param neighborEntryLen uint16_t
 */
#define emberAfFillCommandEnceliumDiagnosticsClusterReportNeighborsResponse(startIndex, \
                                                                            entries, \
                                                                            neighborEntry, \
                                                                            neighborEntryLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_ENCELIUM_DIAGNOSTICS_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_REPORT_NEIGHBORS_RESPONSE_COMMAND_ID, \
                                                "uub", \
                                                startIndex, \
                                                entries, \
                                                neighborEntry, \
...
/** @brief Request to report proximity nodes at a page starting at the specified index.
 *
 * Cluster: Encelium Diagnostics, This cluster provides means to monitor network health by providing data on the bi-directional
      RSSI and LQI connective strength between nodes.
 * Command: ReportProximityNodes
 * @param startIndex uint8_t
 */
#define emberAfFillCommandEnceliumDiagnosticsClusterReportProximityNodes(startIndex) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_ENCELIUM_DIAGNOSTICS_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_REPORT_PROXIMITY_NODES_COMMAND_ID, \
                                                "u", \
                                                startIndex);


/** @brief Report proximity nodes response.
 *
 * Cluster: Encelium Diagnostics, This cluster provides means to monitor network health by providing data on the bi-directional
      RSSI and LQI connective strength between nodes.
 * Command: ReportProximityNodesResponse
 * @param startIndex uint8_t
 * @param entries uint8_t
 * @param proximityNodesResponse uint8_t*
 * @param proximityNodesResponseLen uint16_t
 */
#define emberAfFillCommandEnceliumDiagnosticsClusterReportProximityNodesResponse(startIndex, \
                                                                                 entries, \
                                                                                 proximityNodesResponse, \
                                                                                 proximityNodesResponseLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                                                ZCL_ENCELIUM_DIAGNOSTICS_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_REPORT_PROXIMITY_NODES_RESPONSE_COMMAND_ID, \
                                                "uub", \
                                                startIndex, \
                                                entries, \
                                                proximityNodesResponse, \
...
/** @brief Reset proximity nodes data.
 *
 * Cluster: Encelium Diagnostics, This cluster provides means to monitor network health by providing data on the bi-directional
      RSSI and LQI connective strength between nodes.
 * Command: ResetProximityNodesData
 */
#define emberAfFillCommandEnceliumDiagnosticsClusterResetProximityNodesData() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_ENCELIUM_DIAGNOSTICS_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_RESET_PROXIMITY_NODES_DATA_COMMAND_ID, \
                                                "");


/** @brief Request to report proximity nodes at a page starting at the specified index, then trigger proximity nodes broadcast for the next page.
 *
 * Cluster: Encelium Diagnostics, This cluster provides means to monitor network health by providing data on the bi-directional
      RSSI and LQI connective strength between nodes.
 * Command: ReportAndTriggerProximityNodes
 * @param startIndex uint8_t
 */
#define emberAfFillCommandEnceliumDiagnosticsClusterReportAndTriggerProximityNodes(startIndex) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_ENCELIUM_DIAGNOSTICS_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_REPORT_AND_TRIGGER_PROXIMITY_NODES_COMMAND_ID, \
                                                "u", \
                                                startIndex);


/** @} END Encelium Diagnostics Commands */


/** @name Encelium DEXAL driver data Commands */
// @{
/** @brief Request to report driver data.
 *
 * Cluster: Encelium DEXAL driver data, This cluster provides a single point to retreive all driver-specific data (burn hours, temperature, etc)
 * Command: queryDriverData
 */
#define emberAfFillCommandEnceliumDexalDriverDataClusterqueryDriverData() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_ENCELIUM_DEXAL_DRIVER_DATA_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_QUERY_DRIVER_DATA_COMMAND_ID, \
                                                "");


/** @brief Response to queryDriverData command.
 *
 * Cluster: Encelium DEXAL driver data, This cluster provides a single point to retreive all driver-specific data (burn hours, temperature, etc)
 * Command: queryDriverDataResponse
 */
#define emberAfFillCommandEnceliumDexalDriverDataClusterqueryDriverDataResponse() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                                                ZCL_ENCELIUM_DEXAL_DRIVER_DATA_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_QUERY_DRIVER_DATA_RESPONSE_COMMAND_ID, \
                                                "");


/** @brief Request to report OEM data for a specific driver.  Arg is the n'th driver found during addressing
 *
 * Cluster: Encelium DEXAL driver data, This cluster provides a single point to retreive all driver-specific data (burn hours, temperature, etc)
 * Command: queryOEMData
 * @param driverIndex uint8_t
 */
#define emberAfFillCommandEnceliumDexalDriverDataClusterqueryOEMData(driverIndex) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_ENCELIUM_DEXAL_DRIVER_DATA_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_QUERY_O_E_M_DATA_COMMAND_ID, \
                                                "u", \
                                                driverIndex);


/** @brief Response to queryOEMData command.
 *
 * Cluster: Encelium DEXAL driver data, This cluster provides a single point to retreive all driver-specific data (burn hours, temperature, etc)
 * Command: queryOEMDataResponse
 */
#define emberAfFillCommandEnceliumDexalDriverDataClusterqueryOEMDataResponse() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                                                ZCL_ENCELIUM_DEXAL_DRIVER_DATA_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_QUERY_O_E_M_DATA_RESPONSE_COMMAND_ID, \
                                                "");


/** @} END Encelium DEXAL driver data Commands */
...
/** @name Encelium Emergency Cluster Commands */
// @{
/** @brief Starts functional or duration test.
 *
 * Cluster: Encelium Emergency Cluster, This cluster implements the interface to an Emergency inverter.
 * Command: StartTest
 * @param testType uint8_t
 */
#define emberAfFillCommandEnceliumEmergencyClusterStartTest(testType) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_ENCELIUM_EMERGENCY_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_START_TEST_COMMAND_ID, \
                                                "u", \
                                                testType);


/** @brief Stops the test in progress.
 *
 * Cluster: Encelium Emergency Cluster, This cluster implements the interface to an Emergency inverter.
 * Command: StopTest
 */
#define emberAfFillCommandEnceliumEmergencyClusterStopTest() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_ENCELIUM_EMERGENCY_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_STOP_TEST_COMMAND_ID, \
                                                "");


/** @brief Enables or disables inhibit.
 *
 * Cluster: Encelium Emergency Cluster, This cluster implements the interface to an Emergency inverter.
 * Command: Inhibit
 * @param enable uint8_t
 */
#define emberAfFillCommandEnceliumEmergencyClusterInhibit(enable) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_ENCELIUM_EMERGENCY_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_INHIBIT_COMMAND_ID, \
                                                "u", \
                                                enable);


/** @brief Starts an Emergency Identify
 *
 * Cluster: Encelium Emergency Cluster, This cluster implements the interface to an Emergency inverter.
 * Command: StartIdentify
 */
#define emberAfFillCommandEnceliumEmergencyClusterStartIdentify() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_ENCELIUM_EMERGENCY_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_START_IDENTIFY_COMMAND_ID, \
                                                "");


/** @brief Prorolong time in multiples of 0.5 minutes.
 *
 * Cluster: Encelium Emergency Cluster, This cluster implements the interface to an Emergency inverter.
 * Command: ProlongTime
 * @param time uint8_t
 */
#define emberAfFillCommandEnceliumEmergencyClusterProlongTime(time) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_ENCELIUM_EMERGENCY_CLUSTER_ID, \
                                                0x110C, \
                                                ZCL_PROLONG_TIME_COMMAND_ID, \
                                                "u", \
                                                time);


/** @} END Encelium Emergency Cluster Commands */
