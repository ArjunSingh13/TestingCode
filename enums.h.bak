...
typedef enum {
  EMBER_ZCL_COMMISSIONING_STATES_DETERMINE_MODE_ENTRY = 0x0003,
  EMBER_ZCL_COMMISSIONING_STATES_DEFAULT_ENTRY        = 0x0006,
  EMBER_ZCL_COMMISSIONING_STATES_PENDING_ENTRY        = 0x0008,
  EMBER_ZCL_COMMISSIONING_STATES_PENDING_SEARCH_ENTRY = 0x000A,
  EMBER_ZCL_COMMISSIONING_STATES_NORM_OPERATION_ENTRY = 0x000C,
  EMBER_ZCL_COMMISSIONING_STATES_AWAIT_NET_DOWN_ENTRY = 0x0010,
} EmberAfCommissioningStates;
...
typedef enum {
  EMBER_ZCL_ECOM_EVENT_FINDING_NETWORK             = 0x00,
  EMBER_ZCL_ECOM_EVENT_NO_NETWORKS_FOUND           = 0x01,
  EMBER_ZCL_ECOM_EVENT_ABORTED_SEARCH              = 0x02,
  EMBER_ZCL_ECOM_EVENT_INDICATE_NETWORK_DOWN       = 0x10,
  EMBER_ZCL_ECOM_EVENT_AUTO_JOINED_NETWORK         = 0x11,
  EMBER_ZCL_ECOM_EVENT_INDICATE_NETWORK_PENDING    = 0x12,
  EMBER_ZCL_ECOM_EVENT_INDICATE_NETWORK_UP         = 0x13,
  EMBER_ZCL_ECOM_EVENT_PENDING_NETWORK_LOST_START  = 0x14,
  EMBER_ZCL_ECOM_EVENT_PENDING_NETWORK_LOST_CANCEL = 0x15,
  EMBER_ZCL_ECOM_EVENT_NETWORK_LOST                = 0x16,
  EMBER_ZCL_ECOM_EVENT_NETWORK_LEAVE_REQUESTED     = 0x17,
  EMBER_ZCL_ECOM_EVENT_COMMISSIONING_MODE_CHANGED  = 0x18,
  EMBER_ZCL_ECOM_EVENT_PCU_DETECTED                = 0x20,
  EMBER_ZCL_ECOM_EVENT_INTERPAN_QUERIED            = 0x21,
  EMBER_ZCL_ECOM_EVENT_IDENTIFY                    = 0x30,
  EMBER_ZCL_ECOM_EVENT_IDENTIFY_STOP               = 0x31,
  EMBER_ZCL_ECOM_EVENT_IDENTIFY_ABORT              = 0x32,
  EMBER_ZCL_ECOM_EVENT_INDICATE_ERROR              = 0x33,
  EMBER_ZCL_ECOM_EVENT_SET_DIM_LEVEL               = 0x34,
  EMBER_ZCL_ECOM_EVENT_IDENTIFYING                 = 0x35,
  EMBER_ZCL_ECOM_EVENT_IDENTIFYING_PATTERN         = 0x36,
  EMBER_ZCL_ECOM_EVENT_DIMMING_SEQUENCE            = 0x37,
  EMBER_ZCL_ECOM_EVENT_REVERSE_WINK_REQUEST        = 0x40,
} EmberAfEcomEvent;
...
typedef enum {
  EMBER_ZCL_ENCEL_COMMISSIONING_TYPE_SLEEPY = 0x00,
  EMBER_ZCL_ENCEL_COMMISSIONING_TYPE_ROUTER = 0x01,
} EmberAfEncelCommissioningType;
...
typedef enum {
  EMBER_ZCL_IMAGE_TYPE_HA_DIMMABLE_LIGHT               = 0x0002,
  EMBER_ZCL_IMAGE_TYPE_WIRELESS_PIR_SENSOR             = 0x0003,
  EMBER_ZCL_IMAGE_TYPE_RF_KEYPAD                       = 0x0004,
  EMBER_ZCL_IMAGE_TYPE_LCM_8_DBM                       = 0x0005,
  EMBER_ZCL_IMAGE_TYPE_LCM_20_DBM                      = 0x0006,
  EMBER_ZCL_IMAGE_TYPE_HA_DIMMABLE_LIGHT_WITH_SKYWORKS = 0x0007,
  EMBER_ZCL_IMAGE_TYPE_ECU                             = 0x0008,
  EMBER_ZCL_IMAGE_TYPE_SAK_8_DBM                       = 0x0009,
  EMBER_ZCL_IMAGE_TYPE_SAK_20_DBM                      = 0x000A,
  EMBER_ZCL_IMAGE_TYPE_WALC                            = 0x000B,
} EmberAfImageType;

typedef enum {
  EMBER_ZCL_INTERFACE_TYPE_UNKNOWN             = 0x00,
  EMBER_ZCL_INTERFACE_TYPE_0_10_V_BALLAST      = 0x01,
  EMBER_ZCL_INTERFACE_TYPE_OCS                 = 0x02,
  EMBER_ZCL_INTERFACE_TYPE_PHOTOSENSOR         = 0x03,
  EMBER_ZCL_INTERFACE_TYPE_CONTACT_CLOSURE     = 0x04,
  EMBER_ZCL_INTERFACE_TYPE_AUXILIARY_BUS       = 0x05,
  EMBER_ZCL_INTERFACE_TYPE_ROUTER              = 0x06,
  EMBER_ZCL_INTERFACE_TYPE_COLOR_DIMMABLE      = 0x07,
  EMBER_ZCL_INTERFACE_TYPE_OCS_EXT_ACT         = 0x40,
  EMBER_ZCL_INTERFACE_TYPE_PHOTOSENSOR_EXT_ACT = 0x41,
  EMBER_ZCL_INTERFACE_TYPE_KEYPAD              = 0x42,
  EMBER_ZCL_INTERFACE_TYPE_DOMED_LED           = 0x43,
  EMBER_ZCL_INTERFACE_TYPE_DOMED_LED_SWITCH    = 0x44,
  EMBER_ZCL_INTERFACE_TYPE_DOMED_OSED          = 0x45,
  EMBER_ZCL_INTERFACE_TYPE_SAK                 = 0x46,
  EMBER_ZCL_INTERFACE_TYPE_SAK_U               = 0x47,
  EMBER_ZCL_INTERFACE_TYPE_SAK_M               = 0x48,
  EMBER_ZCL_INTERFACE_TYPE_WIRELESS_MANAGER    = 0x80,
...
typedef enum {
  EMBER_ZCL_OMFG_TEST_NONE            = 0x0000,
  EMBER_ZCL_OMFG_TEST_SELF            = 0x0001,
  EMBER_ZCL_OMFG_TEST_FLASH           = 0x0002,
  EMBER_ZCL_OMFG_TEST_KEYPAD_LED      = 0x0010,
  EMBER_ZCL_OMFG_TEST_KEYPAD_BUTTON   = 0x0011,
  EMBER_ZCL_OMFG_TEST_KEYPAD_LIGHT    = 0x0012,
  EMBER_ZCL_OMFG_TEST_KEYPAD_PROX     = 0x0013,
  EMBER_ZCL_OMFG_TEST_KEYPAD_ICON_LED = 0x0014,
  EMBER_ZCL_OMFG_TEST_SENSOR_OCS      = 0x0020,
  EMBER_ZCL_OMFG_TEST_SENSOR_LIGHT    = 0x0021,
  EMBER_ZCL_OMFG_TEST_SENSOR          = 0x0022,
  EMBER_ZCL_OMFG_TEST_SENSOR_BUTTON   = 0x0023,
  EMBER_ZCL_OMFG_TEST_SENSOR_LED      = 0x0024,
  EMBER_ZCL_OMFG_TEST_SLEEP           = 0x0030,
  EMBER_ZCL_OMFG_TEST_ABORT           = 0x8000,
} EmberAfOmfgTest;

typedef enum {
  EMBER_ZCL_OMFG_TEST_RESULT_PASSED         = 0x0000,
  EMBER_ZCL_OMFG_TEST_RESULT_FAILED         = 0x0001,
  EMBER_ZCL_OMFG_TEST_RESULT_INVALID_TEST   = 0x0002,
  EMBER_ZCL_OMFG_TEST_RESULT_WRONG_MODE     = 0x0003,
  EMBER_ZCL_OMFG_TEST_RESULT_ABORTED        = 0x0004,
  EMBER_ZCL_OMFG_TEST_RESULT_CO_PRO_SULKING = 0x0005,
  EMBER_ZCL_OMFG_TEST_RESULT_PENDING        = 0x0006,
} EmberAfOmfgTestResult;

typedef enum {
  EMBER_ZCL_OMFG_TICK_RESULT_PENDING         = 0x8000,
  EMBER_ZCL_OMFG_TICK_RESULT_COMPLETE        = 0x0001,
  EMBER_ZCL_OMFG_TICK_RESULT_COMPLETE_REBOOT = 0x0002,
  EMBER_ZCL_OMFG_TICK_RESULT_BYPASSED        = 0x0003,
} EmberAfOmfgTickResult;
