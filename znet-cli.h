...
/** @addtogroup plugin-encelium-commissioning Plugin Commands: Encelium Commissioning
 * @ingroup cli
 * The Encelium Commissioning plugin contributes a CLI command to the
 * application framework to be used for debugging purposes.
 * 
 * @{
 */

/** @brief <b>plugin encelium-commissioning mode autojoin </b>
 *   - <i>Force commissioning state to auto-join.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_COMMISSIONING_PLUGIN_ENCELIUM_COMMISSIONING_MODE_AUTOJOIN

/** @brief <b>plugin encelium-commissioning mode default </b>
 *   - <i>Force commissioning state to default.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_COMMISSIONING_PLUGIN_ENCELIUM_COMMISSIONING_MODE_DEFAULT

/** @brief <b>plugin encelium-commissioning mode info </b>
 *   - <i>Print commissioning mode info.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_COMMISSIONING_PLUGIN_ENCELIUM_COMMISSIONING_MODE_INFO

/** @brief <b>plugin encelium-commissioning mode leave </b>
 *   - <i>Leave the current network.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_COMMISSIONING_PLUGIN_ENCELIUM_COMMISSIONING_MODE_LEAVE

/** @brief <b>plugin encelium-commissioning mode pending </b>
 *   - <i>Force commissioning state to pending.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_COMMISSIONING_PLUGIN_ENCELIUM_COMMISSIONING_MODE_PENDING

/** @brief <b>plugin encelium-commissioning network chmask [index:4] </b>
 *   - <i>Specify network channel mask to search in.</i>
 *     - index - INT32U - channel mask
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_COMMISSIONING_PLUGIN_ENCELIUM_COMMISSIONING_NETWORK_CHMASK

/** @brief <b>plugin encelium-commissioning network keyindex [index:1] </b>
 *   - <i>Select link key index to join with.</i>
 *     - index - INT8U - key index
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_COMMISSIONING_PLUGIN_ENCELIUM_COMMISSIONING_NETWORK_KEYINDEX

/** @brief <b>plugin encelium-commissioning network validate [reboot:1] </b>
 *   - <i>Validate current network as commissioned.</i>
 *     - reboot - BOOLEAN - reboot request
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_COMMISSIONING_PLUGIN_ENCELIUM_COMMISSIONING_NETWORK_VALIDATE

/** @brief <b>plugin encelium-commissioning network xpanid [index:8] </b>
 *   - <i>Specify extended pan ID to search for.</i>
 *     - index - IEEE_ADDRESS - extended Pan ID
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_COMMISSIONING_PLUGIN_ENCELIUM_COMMISSIONING_NETWORK_XPANID

/** @} */ // end group plugin-encelium-commissioning

/** @addtogroup plugin-encelium-interface Plugin Commands: Encelium Interface
 * @ingroup cli
 * The Encelium Interface plugin contributes a CLI command to the application
 * framework to be used for debugging purposes.
 * 
 * @{
 */

/** @brief <b>plugin encelium-interface enable [index:1] [enable:1] </b>
 *   - <i>Enables/disables an endpoint.  A disabled endpoint will not show in an ActiveEndpointsResponse, and not respond to attribute read/writes, etc...</i>
 *     - index - INT8U - Endpoint
 *     - enable - BOOLEAN - Enable
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_INTERFACE_PLUGIN_ENCELIUM_INTERFACE_ENABLE

/** @brief <b>plugin encelium-interface print </b>
 *   - <i>Prints encelium-interface data.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_INTERFACE_PLUGIN_ENCELIUM_INTERFACE_PRINT

/** @brief <b>plugin encelium-interface set [index:1] [type:1] </b>
 *   - <i>Sets the encelium-interface type.</i>
 *     - index - INT8U - Endpoint
 *     - type - INT8U - Interface Type
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_INTERFACE_PLUGIN_ENCELIUM_INTERFACE_SET

/** @brief <b>plugin encelium-interface setactive [index:1] [enable:1] </b>
 *   - <i>Activates/deactivates an endpoint.  An inactive endpoint will show in an ActiveEndpointsResponse, but not in the Interpan InterfaceConfig, but will respond to attribute read/writes, etc...</i>
 *     - index - INT8U - Endpoint
 *     - enable - BOOLEAN - SetActive
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_INTERFACE_PLUGIN_ENCELIUM_INTERFACE_SETACTIVE

/** @} */ // end group plugin-encelium-interface

/** @addtogroup plugin-encelium-interpan Plugin Commands: Encelium Interpan
 * @ingroup cli
 * The Encelium Interpan plugin contributes a CLI command to the application
 * framework to be used for debugging purposes.
 * 
 * @{
 */

/** @brief <b>plugin encelium-interpan send-interface-config [index:1] </b>
 *   - <i>Broadcasts interface-config interpan command.</i>
 *     - index - INT8U - Interface Index
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_ENCELIUM_INTERPAN_PLUGIN_ENCELIUM_INTERPAN_SEND_INTERFACE_CONFIG

/** @} */ // end group plugin-encelium-interpan
